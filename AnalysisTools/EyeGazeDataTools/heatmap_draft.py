...
background_image_path = "./images/The-Cookie-Theft-Picture-from-the-Boston-Diagnostic-Aphasia-Examination-For-the-PD-task.png"
...
with plotting.paper_theme():
    ...
    plt.axis('off')
    plt.title("Heatmap Overlay", fontsize=10)
    plt.show()
